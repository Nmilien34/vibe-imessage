...
#ifndef VIBE_MESSAGESEXTENSION_SWIFT_H
#define VIBE_MESSAGESEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Vibe_MessagesExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC22Vibe_MessagesExtension15CameraViewModel")
...
@interface CameraViewModel (SWIFT_EXTENSION(Vibe_MessagesExtension)) <AVCapturePhotoCaptureDelegate>
...
@interface CameraViewModel (SWIFT_EXTENSION(Vibe_MessagesExtension)) <AVCaptureFileOutputRecordingDelegate>
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC22Vibe_MessagesExtension22MessagesViewController")
